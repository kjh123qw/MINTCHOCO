    ...
    <div id="footer_wrap">
        <div class="footer_top">
            ...
            <div class="contact_us">
                <h3>CONTACT US</h3>
                <p>137, Gasan digital 1-ro, Geumcheon-gu, Seoul, Republic of Korea</p>
                <p>+82 1234-5678</p>
                <p><a href="#">info&#64;mt.com</a></p>
            </div>
            <div class="follow_us">
                <h3>FOLLOW US</h3>
                ...
                <a href="http://www.instagram.com" target="_blank"><span><i class="fab fa-instagram"></i></span></a>
            </div>
        </div>
        <div class="footer_bottom">
			<div class="footer_copyright">
				<span>&copy; 2020 Mintchoco, Corp. All rights reserved.</span>
			</div>
