...
<div id="mov_list">
	...
	<div class="movie">
    	...
    	<table border="1">
			...
			<tr>
			    <td rowspan="6"><img src="moviePoster/I_Am_a_Hero.webp" alt="I_Am_a_Hero" onclick="location.href='movieList.html'"></td>
	...
	<div class="rating">
		...
		<table border="1">
			<tr>
				...
				<td style="width: 15%;"> <img src="rating/mincho.png" alt="mincho"><img src="rating/mincho.png" alt="mincho"><img src="rating/mincho.png" alt="mincho"><img src="rating/mincho.png" alt="mincho"><img src="rating/mincho.png" alt="mincho"> </td>
				<td style="width: 60%;"> 꼭 봐라 </td>
				<td style="width: 10%;"> 김정메 </td>
			</tr>
			<tr>
				<td style="width: 15%;"> Standard </td>
				<td style="width: 15%;"> <img src="rating/mincho.png" alt="mincho"><img src="rating/mincho.png" alt="mincho"><img src="rating/mincho.png" alt="mincho"><img src="rating/mincho.png" alt="mincho"> </td>
				<td style="width: 60%;"> 그냥 볼만했는데요? </td>
				<td style="width: 10%;"> 최원준 </td>
			</tr>
			<tr>
				<td style="width: 15%;"> Standard </td>
				<td style="width: 15%;"> <img src="rating/mincho.png" alt="mincho"><img src="rating/mincho.png" alt="mincho"> </td>
				<td style="width: 60%;"> 이런걸 누가봐요~ </td>
				<td style="width: 10%;"> 유지상 </td>
			</tr>
			<tr>
				<td style="width: 15%;"> Standard </td>
				<td style="width: 15%;"> <img src="rating/mincho.png" alt="mincho"><img src="rating/mincho.png" alt="mincho"><img src="rating/mincho.png" alt="mincho"> </td>
			...
			<tr>
				...
				<td style="width: 15%;"> <img src="rating/mincho.png" alt="mincho"> </td>
