	...
	public List<MovieVO> selectMovieList() {
		...
		try {
			...
			while(rs.next()) {
				...
				movieVO.setMovieKind(rs.getString("movieKind"));
				movieVO.setMovieDirector(rs.getString("movieDirector"));
				movieVO.setMovieActor(rs.getString("movieActor"));
				movieVO.setMovieGrade(rs.getString("movieGrade"));
				movieVO.setMovieTime(rs.getString("movieTime"));
				movieVO.setMovieDate(rs.getString("movie_date"));
				movieVO.setMovieYoutubeUrl(rs.getString("movie_youtubu_url"));
